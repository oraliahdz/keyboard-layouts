...
genKB = function(layout) {
  ...
  for (r = i = 0, len = layout.length; i < len; r = ++i) {
    ...
    for (k = j = 0, len1 = row.length; j < len1; k = ++j) {
      key = row[k];
      if(k === 0) {
        newRow += '<div class="split0">';
      }
      if(k === 5) {
        newRow += '</div> <div class="split1">';
      }
...
changeStyleCss = function(style) {
  if (style === "split") {
    document.getElementById("row1").style["margin-left"] = "0";
    document.getElementById("row2").style["margin-left"] = "0";
    document.getElementById("row3").style["margin-left"] = "0";
  }else{
    document.getElementById("row1").style["margin-left"] = "1.5rem";
    document.getElementById("row2").style["margin-left"] = "2.25rem";
    document.getElementById("row3").style["margin-left"] = "3.75rem";
  }
};
